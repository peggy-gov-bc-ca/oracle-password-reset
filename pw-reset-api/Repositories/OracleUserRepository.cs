...
namespace pw_reset_api.Repositories
{
    public class OracleUserRepository : IOracleUserRepository
    {
        ...
        private void ConfigOracle()
        {
                        // This sample demonstrates how to use ODP.NET Core Configuration API

            // Add connect descriptors and net service names entries.
            OracleConfiguration.OracleDataSources.Add("orclcdb", "(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=localhost)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=ORCLCDB.localdomain)(SERVER=dedicated)))");
